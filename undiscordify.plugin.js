...
module.exports = class undiscordify {
    ...
    getName(){return "undiscordify";}
    getDescription(){return  "hellowo";}
    getVersion(){return "0.0.1";}
    getAuthor(){return "nobody";}

    start(){
        console.log('undiscordify is now enabled')
    }
    stop(){
        console.log('undiscordify is now disabled')
    }

load(){ 
    console.log('undiscordify started')
    let popover;
    let btn;
    let stop;
        ...
        function initUI() {
            ...
            <div id="undiscord" style="display:none;">
                ...
                <pre class="logarea">
                    <center><a>thank you for download this mod</a>
                    </center>
                </pre>
            </div>
            `);
